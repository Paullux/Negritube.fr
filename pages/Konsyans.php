  ...
  <div class="my_page">
    <div class="video_page">
      ...
      <div class="myCanvas">
        ...
        <canvas class="canvas" id='canvas' width="800" height="350" style="background-image: url('../assets/img/album cover/philippe_konsyans.png');background-size: cover;"></canvas>
      </div>
      <br>
