...
<head>
  ...
  <meta charset="utf-8">
  <!-- HTML Meta Tags -->
  <title>Negritube.fr - Chanson hommage à 3 Gwo-Mòdan</title>
  <meta name="description" content="Une vidéo en Live : Chanson hommage à 3 Gwo-Mòdan">
  <meta name="keywords" content="créole" />
  <meta name="author" content="Philippe Blaze" />
  <meta name="theme-color" content="#f6b73c" />

  <!-- Facebook Meta Tags -->
  <meta property="og:url" content="https://negritube.fr/pages/Chanson_Hommage_aux_Gwo_Mòdan.php">
  <meta property="og:type" content="website">
  <meta property="og:title" content="Negritube.fr - Chanson hommage à 3 Gwo-Mòdan">
  <meta property="og:description" content="Une vidéo en Live : Chanson hommage à 3 Gwo-Mòdan">
  <meta property="og:image" content="https://negritube.fr/assets/img/miniature/Chanson_Hommage_aux_Gwo_Mòdan.png">
  <meta property="og:locale" content="fr_FR" />

  <!-- Twitter Meta Tags -->
  <meta name="twitter:card" content="summary" />
  <meta property="twitter:domain" content="negritube.fr">
  <meta property="twitter:url" content="https://negritube.fr/pages/Chanson_Hommage_aux_Gwo_Mòdan.php">
  <meta name="twitter:title" content="Negritube.fr - Chanson hommage à 3 Gwo-Mòdan">
  <meta name="twitter:description" content="Une vidéo en Live : Chanson hommage à 3 Gwo-Mòdan">
  <meta name="twitter:image" content="https://negritube.fr/assets/img/miniature/Chanson_Hommage_aux_Gwo_Mòdan.png">
    ...
    <div class="video_page">
      ...
      <div class="player">
        <video controls playsinline autoplay controlsList="nodownload">
          <source src="../assets/videos/Chanson_Hommage_aux_Gwo_Mòdan.mp4" type="video/mp4" />
          <source src="../assets/videos/Chanson_Hommage_aux_Gwo_Mòdan.mp4" type="video/webm" />
        </video>
        <div class="controls">
        ...
        <div style="height:10px;font-size:10px;">&nbsp;</div>
        <h3 class="song_title" id="title">
          Chanson hommage à 3 Gwo-Mòdan (3 grands artistes) : Manu Dibango, Henri Salvador, ChristoPhe
        </h3>
        <p class="description">
