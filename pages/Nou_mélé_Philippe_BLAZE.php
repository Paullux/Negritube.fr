...
<head>
  ...
  <meta name="description" content="Une vidéo en Live : Nou mélé (Philippe BLAZE)">
  <meta name="keywords" content="créole" />
  <meta name="author" content="Philippe Blaze" />
  <meta name="theme-color" content="#f6b73c" />

  <!-- Facebook Meta Tags -->
  <meta property="og:url" content="https://negritube.fr/pages/Nou_mélé_Philippe_BLAZE.php">
  <meta property="og:type" content="website">
  <meta property="og:title" content="Negritube.fr - Nou mélé (Philippe BLAZE)">
  <meta property="og:description" content="Une vidéo en Live : Nou mélé (Philippe BLAZE)">
  <meta property="og:image" content="https://negritube.fr/assets/img/miniature/Nou_mélé_Philippe_BLAZE.png">
  <meta property="og:locale" content="fr_FR" />

  <!-- Twitter Meta Tags -->
  <meta name="twitter:card" content="summary" />
  <meta property="twitter:domain" content="negritube.fr">
  <meta property="twitter:url" content="https://negritube.fr/pages/Nou_mélé_Philippe_BLAZE.php">
  <meta name="twitter:title" content="Negritube.fr - Nou mélé (Philippe BLAZE)">
  <meta name="twitter:description" content="Une vidéo en Live : Nou mélé (Philippe BLAZE)">
  <meta name="twitter:image" content="https://negritube.fr/assets/img/miniature/Nou_mélé_Philippe_BLAZE.png">
    ...
    <div class="video_page">
      ...
      <div class="player">
        <video controls playsinline autoplay controlsList="nodownload">
          <source src="../assets/videos/Nou_mélé_Philippe_BLAZE.mp4" type="video/mp4" />
          <source src="../assets/videos/Nou_mélé_Philippe_BLAZE.mp4" type="video/webm" />
        </video>
        <div class="controls">
        ...
        <div style="height:10px;font-size:10px;">&nbsp;</div>
        <h3 class="song_title" id="title">
          Nou mélé (Philippe BLAZE)
        </h3>
        <p class="description">
          #gwokaévolutif. "Nou mélé" : version acoustique guitare/voix d'une chanson de l'un des albums de mon groupe JÒDLA, évoquant une page de l'histoire contemporaine de la Guadeloupe. Bonne écoute. Version CD en rupture de stocks. Sera bientôt sur les plateformes de téléchargement. <br>
          #Gwokaévolutif.<br>
