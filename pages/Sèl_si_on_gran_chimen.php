...
<head>
  ...
  <meta charset="utf-8">
  <!-- HTML Meta Tags -->
  <title>Negritube.fr - Sèl si on gran chimen (un zouk)</title>
  <meta name="description" content="Une vidéo en Live : Sèl si on gran chimen (un zouk)">
  <meta name="keywords" content="créole" />
  <meta name="author" content="Philippe Blaze" />
  <meta name="theme-color" content="#f6b73c" />

  <!-- Facebook Meta Tags -->
  <meta property="og:url" content="https://negritube.fr/pages/Sèl_si_on_gran_chimen.php">
  <meta property="og:type" content="website">
  <meta property="og:title" content="Negritube.fr - Sèl si on gran chimen (un zouk)">
  <meta property="og:description" content="Une vidéo en Live : Sèl si on gran chimen (un zouk)">
  <meta property="og:image" content="https://negritube.fr/assets/img/miniature/Sèl_si_on_gran_chimen.png">
  <meta property="og:locale" content="fr_FR" />

  <!-- Twitter Meta Tags -->
  <meta name="twitter:card" content="summary" />
  <meta property="twitter:domain" content="negritube.fr">
  <meta property="twitter:url" content="https://negritube.fr/pages/Sèl_si_on_gran_chimen.php">
  <meta name="twitter:title" content="Negritube.fr - Sèl si on gran chimen (un zouk)">
  <meta name="twitter:description" content="Une vidéo en Live : Sèl si on gran chimen (un zouk)">
  <meta name="twitter:image" content="https://negritube.fr/assets/img/miniature/Sèl_si_on_gran_chimen.png">
    ...
    <div class="video_page">
      ...
      <div class="player">
        <video controls playsinline autoplay controlsList="nodownload">
          <source src="../assets/videos/Sèl_si_on_gran_chimen.mp4" type="video/mp4" />
          <source src="../assets/videos/Sèl_si_on_gran_chimen.mp4" type="video/webm" />
        </video>
        <div class="controls">
        ...
        <div style="height:10px;font-size:10px;">&nbsp;</div>
        <h3 class="song_title" id="title">
          Sèl si on gran chimen
        </h3>
        <p class="description">
          #zouk. Une illustration de ma période zouk - début des années 90
        </p>
