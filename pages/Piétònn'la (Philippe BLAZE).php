  ...
  <div class="my_page">
    <div class="video_page">
      ...
      <h3 class="song_title" id="title">
        Une vidéo de Gwoka évolutif : Piétònn'la (Philippe BLAZE)
      </h3>
      <br>
      <br>
      <div class="hidden">
      ...
      <div class="player">
        <video controls playsinline autoplay controlsList="nodownload">
          <source src="../assets/videos/Piétònn'la (Philippe BLAZE).mp4" type="video/mp4" />
          <source src="../assets/videos/Piétònn'la (Philippe BLAZE).mp4" type="video/webm" />
